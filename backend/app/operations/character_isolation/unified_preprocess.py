"""
Soft Preprocessing Module for Handwritten Chinese OCR
-----------------------------------------------------
Preserves stroke detail while removing background noise.
Suitable for calligraphy-like scanned characters.
"""
...
def process_crop(image, target_size=(64, 64)):
    """
    Process a single cropped character image.

    Args:
        image: np.array, cropped RGB or grayscale character
        target_size: tuple, (width, height)

    Returns:
        dict: {"parts": [processed_img], "keep": True/False}
    """
    try:
